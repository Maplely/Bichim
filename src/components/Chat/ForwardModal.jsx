    ...
    <div onClick={e => e.target === e.currentTarget && onClose()} style={{
      ...
      <div style={{ background: M.mantle, border: `1px solid ${M.surface0}`, borderRadius: '16px', width: '100%', maxWidth: '400px', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '8px 16px', position: 'relative' }}>
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Buscar sala..." style={{ width: '100%', padding: '8px 8px 8px 28px', background: M.surface0, border: 'none', borderRadius: 10, color: M.text, fontSize: '0.82rem', outline: 'none' }} />
        </div>
