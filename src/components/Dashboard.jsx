...
import { FaSignOutAlt, FaPlus, FaHashtag, FaClipboard, FaCheck, FaArrowRight, FaArrowLeft, FaRocket, FaSmile } from 'react-icons/fa';
  ...
  return (
    <div style={{ minHeight: '100vh', background: M.base, fontFamily: 'system-ui,-apple-system,sans-serif', color: M.text }}>
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src={M.base === '#0F0F0F' ? '/BichimDarkMode.svg' : '/BichimWhiteMode.svg'} alt="Bichim" style={{ width: 32, height: 32, borderRadius: '50%' }} />
      ...
      <main style={{ maxWidth: '920px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        {rooms.length === 0 && (
          <div style={{ textAlign: 'center', padding: '80px 20px', color: M.sub0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
            <img src={M.base === '#0F0F0F' ? '/BichimDarkMode.svg' : '/BichimWhiteMode.svg'} alt="Bichim" style={{ width: 48, height: 48, opacity: 0.2 }} />
